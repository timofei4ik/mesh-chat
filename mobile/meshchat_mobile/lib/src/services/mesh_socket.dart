...
class MeshSocket {
  ...
  Map<String, dynamic> _helloPacket(
    ...
    return {
      ...
      'privacy_show_online': profile?.privacyShowOnline,
      'privacy_show_avatar': profile?.privacyShowAvatar,
      'privacy_show_about': profile?.privacyShowAbout,
      'direct_message_privacy': profile?.directMessagePrivacy,
